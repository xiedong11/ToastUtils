package com.zhuandian.datapicker.view;
...
import com.zhuandian.datapicker.R;
...
public class CustomDatePicker {
     ...
     * 定义取消回调接口
     */
    public interface CancelResultHandler{
        void handleCancel();
    }
    ...
    private CancelResultHandler cancelHandler;
    ...
    public CustomDatePicker(Context context, ResultHandler resultHandler, String startDate, String endDate, CancelResultHandler cancelHandler) {
    ...
    public void setSelectedTime(String time) {
        if (canAccess) {
            ...
            if (selectedYear == startYear) {
                ...
                for (int i = startMonth; i <= endNum; i++) {
                    month.add(formatTimeUnit(i));
                }
            } else if (selectedYear == endYear) {
                for (int i = 1; i <= endMonth; i++) {
